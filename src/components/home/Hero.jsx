        ...
        <div className='bg-hero-bg bg-cover bg-center xl:pb-[527px] lg:pb-[657px] pb-[378.95px]'>
           <div className=' bg-deepBlue'>
            ...
            <div className='max-w-[1072px] mx-auto w-full px-3'>
                <h1 className='max-w-[1072px] max-lg:max-w-2xl mx-auto text-white font-bold lg:text-[61px] md:text-4xl text-[30px] text-center !leading-[136.2%] xl:mt-[68px] lg:mt-[71px] md:mt-12 mt-[39px] lg:mb-[15px] mb-[14px]'>Driving Transformation for Performance and Passion Within </h1>
